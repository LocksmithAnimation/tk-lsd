...
class Ui_SetupNewOS(object):
    ...
    def retranslateUi(self, SetupNewOS):
        SetupNewOS.setWindowTitle(
            QCoreApplication.translate("SetupNewOS", "Form", None)
        )
        self.icon.setText("")
        self.text.setText(
            QCoreApplication.translate("SetupNewOS", "Python not found", None)
        )
        self.button.setText(
            QCoreApplication.translate("SetupNewOS", "Learn More", None)
        )
        self.label.setText(
            QCoreApplication.translate(
                "SetupNewOS",
                "You need to configure the location of Python for this project and operating system.\n"
                "\n"
                "Click to view the docs on how to update your configuration.",
                None,
            )
        )
