...
class Ui_LoadingProjectWidget(object):
    ...
    def retranslateUi(self, LoadingProjectWidget):
        LoadingProjectWidget.setWindowTitle(
            QCoreApplication.translate("LoadingProjectWidget", "Form", None)
        )
        self.show_hide_details.setText(
            QCoreApplication.translate("LoadingProjectWidget", "show details", None)
        )
