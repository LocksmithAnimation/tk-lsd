...
class Ui_SetupProject(object):
    ...
    def retranslateUi(self, SetupProject):
        SetupProject.setWindowTitle(
            QCoreApplication.translate("SetupProject", "Form", None)
        )
        self.icon.setText("")
        self.text.setText(
            QCoreApplication.translate("SetupProject", "Set Up Toolkit Project", None)
        )
        self.button.setText(
            QCoreApplication.translate("SetupProject", "Set up Project", None)
        )
