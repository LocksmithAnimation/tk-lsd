...
class Ui_BrowserIntegrationUserSwitchDialog(object):
    def setupUi(self, BrowserIntegrationUserSwitchDialog):
        if not BrowserIntegrationUserSwitchDialog.objectName():
            BrowserIntegrationUserSwitchDialog.setObjectName(
        ...
        sizePolicy1.setHeightForWidth(
            self.restart_button.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy1.setHeightForWidth(
            self.ignore_button.sizePolicy().hasHeightForWidth()
        )
    ...
    def retranslateUi(self, BrowserIntegrationUserSwitchDialog):
        BrowserIntegrationUserSwitchDialog.setWindowTitle(
        ...
        self.reason_label.setText(
            QCoreApplication.translate(
                "BrowserIntegrationUserSwitchDialog", "TextLabel", None
            )
        )
        self.ignore_checkbox.setText(
            QCoreApplication.translate(
                "BrowserIntegrationUserSwitchDialog",
                "Ignore requests from this site until the next restart",
                None,
            )
        )
        self.restart_button.setText(
            QCoreApplication.translate(
                "BrowserIntegrationUserSwitchDialog", "Restart", None
            )
        )
        self.ignore_button.setText(
            QCoreApplication.translate(
                "BrowserIntegrationUserSwitchDialog", "Ignore", None
            )
        )
        self.label_2.setText(
            QCoreApplication.translate(
                "BrowserIntegrationUserSwitchDialog",
                '<a href="https://help.autodesk.com/view/SGSUB/ENU/?guid=SG_Supervisor_Artist_sa_integrations_sa_integrations_user_guide_html#Authentication%20and%20browser%20integration">Why is a restart required?</a>',
                None,
            )
        )
